...
function App() {
  return (
    <QueryClientProvider client={queryClient}>
      <BrowserRouter>
        <Routes>
          {/* Định nghĩa tuyến đường cho trang đăng nhập và đăng ký */}
          <Route path='/Movie/login' element={<RouteSignIn />}>
          ...
          {/* Tuyến đường chính, chuyển hướng đến trang đăng nhập */}
          <Route path="/" element={<Navigate to="/Movie/login" replace />} />
