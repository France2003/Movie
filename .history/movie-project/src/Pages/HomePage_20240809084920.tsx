    ...
    return (
        <>
            ...
            <section className="home container w-[1060px] mx-auto my-8" id="home">
                <img src="https://movie-site-delta.vercel.app/img/home-background.png" alt="" className="home-img animate-from-left" />
                <div className="home-text mt-8 animate-from-right">
            ...
            <div className="next-page mt-8 animate-from-right">
