...
const MoviesDetailPage = () => {
  ...
  const getMovieDetails = async (id: number) => {
    try {
      ...
      console.log("Dữ liệu phản hồi từ API:", result.data); // Gỡ lỗi: log phản hồi API
      return result.data;
    } catch (error) {
  ...
  const handleWatchFullMovie = (e: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
    ...
    if (fullMovieUrl) {
      ...
      alert("Xin lỗi, không có phim đầy đủ.");
    }
  };
