        ...
        <>
            ...
            <section className="popular container mx-auto my-8" id="popular">
                <div className="heading  mb-4 mt-2">
                    <h2 className="heading-title text-2xl font-semibold text-gradient background-color ">
                        Popular Movies
                    </h2>
                </div>
            ...
            <section className="movies-container container mx-auto my-8" id="movies">
                <div className="heading mb-4">
                    <h2 className="heading-title text-2xl font-semibold text-gradient background-color">Now Playing</h2>
                </div>
