...
const RankingPage = () => {
  ...
  return (
    <div className=" ranking p-6 bg-[#1e1e2a] m-auto w-[1200px] mt-[70px] animate__animated animate__fadeIn">
      ...
      {movies.length > 0 ? (
        <ul className="space-y-6">
          {movies.map((movie, index) => (
            <li
              key={movie.id}
              className="bg-[#2e2e38] ranking_movie rounded-lg shadow-md flex items-center p-4 hover:shadow-lg transition-shadow duration-300 animate__animated animate__fadeInUp"
            >
