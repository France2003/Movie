...
function SearchResultsPage() {
    ...
    return (
        <div className="w-full max-w-screen-lg mx-auto mt-[250px] px-6">
                        ...
                        <div key={movie.id} className="bg-[#1e1e2a] rounded-lg shadow-md p-4 hover:shadow-lg transition-shadow duration-300 ">
                            <Link to={`/movie/${movie.id}`} className="group flex flex-col items-center">
                                ...
                                <img
                                    ...
                                    className=" image  w-full h-auto object-cover rounded-md transition-transform duration-300 group-hover:scale-105 group-hover:rotate-1 group-hover:shadow-lg"
