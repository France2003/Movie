...
const FavoritesPage = () => {
  ...
  const removeFavorite = ({movieId,original_title}:IMoviesDetail) => {
    ...
    // Show notification
    setNotification(`Đã xóa ${original_title} khỏi danh sách yêu thích!`);
  ...
  return (
    <div className="p-6 bg-[#1e1e2a] mt-[70px] m-auto w-[1200px]">
      ...
      {/* Notification */}
      {notification && (
        <div className="mb-4 p-3 bg-green-600 text-white w-[250px] fixed top-[90px] left-[1260px]  z-10  rounded-md">
          {notification}
        </div>
      )}
