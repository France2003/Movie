...
function Register({ url }: { url: string }) {
    ...
    const handleRegister = (e: React.FormEvent) => {
        ...
        // Optionally, you can navigate to the login page after a short delay to show the success message
        setTimeout(() => {
            navigate("/Movie/login");
        }, 2000); // Delay before navigation to allow user to see the success message
    };
