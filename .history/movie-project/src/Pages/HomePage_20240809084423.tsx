    ...
    return (
        <>
            ...
            <section className="home container w-[1060px] mx-auto my-8" id="home">
                <img src="https://movie-site-delta.vercel.app/img/home-background.png" alt="" className="home-img animate-fade-in" />
            ...
            <section className="popular container mx-auto my-8" id="popular">
                ...
                <div className="popular-content swiper animate-fade-in">
            ...
            <div className="movies-content mt-8 animate-fade-in">
