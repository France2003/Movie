    ...
    return (
        <header>
            <div className="nav container w-[1060px]">
                <Link className="logo" to={``}>MOVIE<span>VENNIE</span></Link>
                ...
                <div className="navbar">
                    <Link to={`/Home`}><NavbarItem type="nav-active" icon={<AiOutlineHome />} label="Home" /></Link>
                    <Link to={`/popular`}><NavbarItem icon={<SiFireship />} label="Popular" /></Link>
                    <Link to={`/now_playing`}><NavbarItem icon={<MdExplore />} label="Now Playing" /></Link>
                    <Link to={`/ranking`}><NavbarItem icon={<FaRankingStar />} label="Ranking" /></Link>
                    <Link to={`/favourite`}><NavbarItem icon={<FaRegHeart />} label="Favourite" /></Link>
                    <Link to={`/login`}><NavbarItem icon={<IoLogOutOutline  />} label="LogIn" /></Link>  
                </div>
            </div>
        </header>
    );
